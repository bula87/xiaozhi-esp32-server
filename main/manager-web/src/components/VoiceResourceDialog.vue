  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
      <el-form-item :label="$t('voiceClone.platformName')" prop="modelId">
        <el-select
          ...
          :placeholder="$t('voiceClone.platformNamePlaceholder')"
          filterable
          style="width: 100%"
          @change="handlePlatformChange"
        >
          <el-option
            v-for="model in platformList"
            :key="model.id"
      ...
      <el-form-item :label="$t('voiceClone.voiceId')" prop="voiceIds">
        <el-select
          ...
          :placeholder="$t('voiceClone.voiceIdPlaceholder')"
          filterable
          multiple
          allow-create
      ...
      <el-form-item :label="$t('voiceClone.userId')" prop="userId">
        <el-select
          v-model="form.userId"
          :placeholder="$t('voiceClone.userIdPlaceholder')"
          filterable
          remote
      ...
      <el-form-item :label="$t('voiceClone.languages')" prop="languages">
        <el-input
          ...
          :placeholder="$t('voiceClone.languagesPlaceholder')"
          style="width: 100%"
        >
        </el-input>
      </el-form-item>
    ...
    <div slot="footer" class="dialog-footer">
      <el-button @click="handleCancel">{{
        $t("voiceClone.operationCancelled")
      }}</el-button>
    ...
    return {
      ...
      rules: {
        modelId: [
          {
            required: true,
            message: this.$t("voiceClone.platformNameRequired"),
            trigger: "change",
          },
        ],
        voiceIds: [
          {
            required: true,
            message: this.$t("voiceClone.voiceIdRequired"),
            trigger: "change",
          },
        ],
        userId: [
          {
            required: true,
            message: this.$t("voiceClone.userIdRequired"),
            trigger: "change",
          },
        ],
        languages: [
          {
            required: true,
            message: this.$t("voiceClone.languagesRequired"),
            trigger: "blur",
          },
        ],
      },
