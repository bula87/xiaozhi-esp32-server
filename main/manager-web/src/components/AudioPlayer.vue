...
// Return the corresponding icon path based on volume status
...
const toggleMute = () => {
  ...
  // If mute is cancelled and volume is 0, restore default volume
  if (!isMuted.value && volume.value === 0) {
    volume.value = 0.5
...
const updateSliderPosition = () => {
  nextTick(() => {
    ...
    // Position to the center of the button, vertically centered
