<template>
  <div class="welcome">
        ...
        <div class="content-area">
          <el-card class="params-card" shadow="never">
            ...
            >
              ...
              ></el-table-column>
              <el-table-column
                :label="$t('voiceClone.name')"
                prop="name"
                align="center"
              ></el-table-column>
              <el-table-column
                :label="$t('voiceClone.userId')"
                prop="userName"
                align="center"
              ></el-table-column>
              <el-table-column
                :label="$t('voiceClone.platformName')"
                prop="modelName"
                align="center"
              ></el-table-column>
              <el-table-column
              ...
              <el-table-column :label="$t('voiceClone.action')" align="center">
                <template slot-scope="scope">
                  <el-button
                    size="mini"
                    type="text"
                    @click="deleteVoiceClone(scope.row)"
            ...
            <div class="table_bottom">
              <div class="ctrl_btn">
                ...
                >
                  {{
                    isAllSelected
                      ? $t("voiceClone.deselectAll")
                      : $t("voiceClone.selectAll")
                  }}
                </el-button>
                <el-button
                  size="mini"
    ...
    <!-- Add voice clone resource dialog -->
    <voice-clone-dialog
      :title="$t('voiceClone.addVoiceClone')"
...
export default {
  ...
  methods: {
    ...
    deleteVoiceClone(row) {
      ...
      this.$confirm(
        this.$t("voiceClone.confirmDelete", { count: itemCount }),
        this.$t("voiceClone.warning"),
        {
        ...
        .then(() => {
          ...
          Api.voiceResource.deleteVoiceResource(ids, (res) => {
            ...
            if (res.code === 0) {
              this.$message.success({
                message: this.$t("voiceClone.deleteSuccess", {
                  count: itemCount,
                }),
                showClose: true,
              });
