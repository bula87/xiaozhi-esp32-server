...
`remark` = 'Tongyi Qianwen Qwen3-ASR-Flash Configuration Instructions:
...
3.Qwen3-ASR-Flash is based on Tongyi Qianwen multimodal foundation, supporting multilingual recognition, singing recognition, noise rejection, etc.
'
