-- Add Doubao speech synthesis model 2.0 provider (using seed-tts-2.0 resource ID)
-- Same as Volcano double-stream TTS configuration, but resource_id is fixed to seed-tts-2.0

-- Insert Doubao speech synthesis model 2.0 provider
...
('SYSTEM_TTS_HSDSTTS_V2', 'TTS', 'huoshan_double_stream', 'Doubao Speech Synthesis Model 2.0', '[
  {"key": "ws_url", "type": "string", "label": "WebSocket URL"},
...
-- Insert Doubao speech synthesis model 2.0 configuration
...
`remark` = 'Doubao Speech Synthesis Model 2.0 Configuration Instructions (based on Volcano Engine seed-tts-2.0):
1. Visit https://www.volcengine.com/ to register and activate a Volcano Engine account
2. Visit https://console.volcengine.com/speech/service/10035 to activate the large speech synthesis model and purchase voices
3. Get appid and access_token at the bottom of the page
4. Resource ID is fixed to: seed-tts-2.0 (Doubao Speech Synthesis Model 2.0)
5. Connection Reuse: Enable WebSocket connection reuse, default true to reduce connection overhead (Note: After reuse, idle connections in listening state will occupy concurrent numbers)

Detailed parameter documentation: https://www.volcengine.com/docs/6561/1329505
[audio_params] Audio Output Configuration - Users can customize any audio parameters supported by the Volcano Engine
  - speech_rate: Speech rate (-50~100), default 0
  - loudness_rate: Volume (-50~100), default 0
  Example: {"speech_rate": 10, "loudness_rate": 5}

[additions] Advanced Text Processing Configuration - Users can customize any advanced parameters supported by the Volcano Engine
...
Note:
- Doubao Speech Synthesis Model 2.0 uses the seed-tts-2.0 resource ID, which is different from Volcano Double-Stream TTS (volc.service_type.10029)
- Voice list: https://www.volcengine.com/docs/6561/1257544
- Users can add more parameters according to the Volcano Engine API documentation
' WHERE `id` = 'TTS_HSDSTTS_V2';

-- Add Doubao speech synthesis model 2.0 voices (same as Volcano double-stream TTS voices)
...
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0008', 'TTS_HSDSTTS_V2', 'Zhi Xing Can Can', 'zh_female_cancan_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_female_cancan_uranus_bigtts.mp3', NULL, NULL, NULL, 8, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0009', 'TTS_HSDSTTS_V2', 'Coquettish Schoolgirl', 'zh_female_sajiaoxuemei_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_female_sajiaoxuemei_uranus_bigtts.mp3', NULL, NULL, NULL, 9, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0010', 'TTS_HSDSTTS_V2', 'Sweet Xiao Yuan', 'zh_female_tianmeixiaoyuan_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_female_tianmeixiaoyuan_uranus_bigtts.mp3', NULL, NULL, NULL, 10, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0011', 'TTS_HSDSTTS_V2', 'Sweet Peaches', 'zh_female_tianmeitaozi_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_female_tianmeitaozi_uranus_bigtts.mp3', NULL, NULL, NULL, 11, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0012', 'TTS_HSDSTTS_V2', 'Brisk Si Si', 'zh_female_shuangkuaisisi_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_female_shuangkuaisisi_uranus_bigtts.mp3', NULL, NULL, NULL, 12, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0013', 'TTS_HSDSTTS_V2', 'Piggy', 'zh_female_peiqi_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_female_peiqi_uranus_bigtts.mp3', NULL, NULL, NULL, 13, NULL, NULL, NULL, NULL);
...
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0015', 'TTS_HSDSTTS_V2', 'Young Zi Xin/Brayan', 'zh_male_shaonianzixin_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_male_shaonianzixin_uranus_bigtts.mp3', NULL, NULL, NULL, 15, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0016', 'TTS_HSDSTTS_V2', 'Monkey Brother', 'zh_male_sunwukong_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_male_sunwukong_uranus_bigtts.mp3', NULL, NULL, NULL, 16, NULL, NULL, NULL, NULL);
...
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0021', 'TTS_HSDSTTS_V2', 'Warm Ah Hu/Alvin', 'zh_male_wennuanahu_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_male_wennuanahu_uranus_bigtts.mp3', NULL, NULL, NULL, 21, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0022', 'TTS_HSDSTTS_V2', 'Naive Cute Kid', 'zh_male_naiqimengwa_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_male_naiqimengwa_uranus_bigtts.mp3', NULL, NULL, NULL, 22, NULL, NULL, NULL, NULL);
...
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0025', 'TTS_HSDSTTS_V2', 'Lightweight Duoduo', 'saturn_zh_female_qingyingduoduo_cs_tob', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/ICL_zh_female_qingyingduoduo_cs_tob.mp3', NULL, NULL, NULL, 25, NULL, NULL, NULL, NULL);
...
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0027', 'TTS_HSDSTTS_V2', 'Overbearing Qing Shu', 'zh_male_baqiqingshu_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_male_baqiqingshu_uranus_bigtts.mp3', NULL, NULL, NULL, 27, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0028', 'TTS_HSDSTTS_V2', 'Mystery Commentary', 'zh_male_xuanyijieshuo_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_male_xuanyijieshuo_uranus_bigtts.mp3', NULL, NULL, NULL, 28, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_HSDSTTS_V2_0029', 'TTS_HSDSTTS_V2', 'Ancient Style Young Lady', 'zh_female_gufengshaoyu_uranus_bigtts', 'Mandarin, English', 'https://lf3-static.bytednsdoc.com/obj/eden-cn/lm_hz_ihsph/ljhwZthlaukjlkulzlp/portal/bigtts/zh_female_gufengshaoyu_uranus_bigtts.mp3', NULL, NULL, NULL, 29, NULL, NULL, NULL, NULL);
