-- Add mobile SMS registration function required parameters
...
(109, 'server.beian_icp_num', 'null', 'string', 1, 'ICP filing number, fill null to not set', NULL, NULL, NULL, NULL),
(110, 'server.beian_ga_num', 'null', 'string', 1, 'Public security filing number, fill null to not set', NULL, NULL, NULL, NULL),
(111, 'server.enable_mobile_register', 'false', 'boolean', 1, 'Whether to enable mobile registration', NULL, NULL, NULL, NULL),
(112, 'server.sms_max_send_count', '10', 'number', 1, 'Maximum daily SMS sent per number', NULL, NULL, NULL, NULL),
...
update sys_params set remark = 'Whether to allow registration by persons other than administrators' where param_code = 'server.allow_user_register';
