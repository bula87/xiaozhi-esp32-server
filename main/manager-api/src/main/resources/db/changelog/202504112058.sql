-- This file is used to initialize system parameter data. It does not need to be executed manually; it will be executed automatically when the project starts.
-- --------------------------------------------------------
...
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (302, 'close_connection_no_voice_time', '120', 'number', 1, 'Disconnect time for no voice input (seconds)');
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (303, 'tts_timeout', '10', 'number', 1, 'TTS request timeout time (seconds)');
...
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (305, 'enable_greeting', 'true', 'boolean', 1, 'Whether to enable greeting reply');
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (306, 'enable_stop_tts_notify', 'false', 'boolean', 1, 'Whether to enable stop prompt sound');
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (307, 'stop_tts_notify_voice', 'config/assets/tts_notify.mp3', 'string', 1, 'Stop prompt sound file path');
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (308, 'exit_commands', 'Exit;Close', 'array', 1, 'List of exit commands');
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (309, 'xiaozhi', '{"type": "hello", "version": 1, "transport": "websocket", "audio_params": {"format": "opus", "sample_rate": 16000, "channels": 1, "frame_duration": 60}}', 'json', 1, 'XiaoZhi Type');
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (310, 'wakeup_words', 'Hello XiaoZhi;Hi XiaoZhi;Xiaoai Classmate;Hello Xiaoxin;Xiaomei Classmate;Xiaolong Xiaolong;Miaomiao Classmate;Xiaobin Xiaobin;Xiaobing Xiaobing', 'array', 1, 'List of wake words');
...
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (423, 'plugins.home_assistant.api_key', 'your_home_assistant_api_access_token', 'string', 1, 'Home Assistant API key');
