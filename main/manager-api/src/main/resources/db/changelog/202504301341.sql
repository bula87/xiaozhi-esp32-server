...
2. Visit https://nls-portal.console.aliyun.com/applist to get the appkey
3. Visit https://nls-portal.console.aliyun.com/overview to get the token
...
(101006, 101, 'DFRobot Air Board k10', 'df-k10', 'DFRobot Air Board k10', 6, 1, NOW(), 1, NOW()),
...
(101016, 101, 'Fish Eagle Tech 3.13LCD Dev Board', 'kevin-yuying-313lcd', 'Fish Eagle Tech 3.13LCD Dev Board', 16, 1, NOW(), 1, NOW()),
(101017, 101, 'Lichuang Practical ESP32-S3 Dev Board', 'lichuang-dev', 'Lichuang Practical ESP32-S3 Dev Board', 17, 1, NOW(), 1, NOW()),
(101018, 101, 'Lichuang Practical ESP32-C3 Dev Board', 'lichuang-c3-dev', 'Lichuang Practical ESP32-C3 Dev Board', 18, 1, NOW(), 1, NOW()),
...
(101042, 101, 'Zhengdian Atom DNESP32S3 Dev Board', 'atk-dnesp32s3', 'Zhengdian Atom DNESP32S3 Dev Board', 42, 1, NOW(), 1, NOW()),
(101043, 101, 'Zhengdian Atom DNESP32S3-BOX', 'atk-dnesp32s3-box', 'Zhengdian Atom DNESP32S3-BOX', 43, 1, NOW(), 1, NOW()),
...
(101053, 101, 'Sibo Smart AI Companion Box', 'doit-s3-aibox', 'Sibo Smart AI Companion Box', 53, 1, NOW(), 1, NOW()),
(101054, 101, 'Yuan Control Youth', 'mixgo-nova', 'Yuan Control Youth', 54, 1, NOW(), 1, NOW());
