-- ===============================
-- I. Insert plugin record into ai_model_provider
-- ===============================
START TRANSACTION;


-- intent_llm and function_call do not set function list
...
-- 4. HomeAssistant device status query
INSERT INTO ai_model_provider (id, model_type, provider_code, name, fields,
                               sort, creator, create_date, updater, update_date)
...
-- 5. HomeAssistant device status modification
INSERT INTO ai_model_provider (id, model_type, provider_code, name, fields,
                               sort, creator, create_date, updater, update_date)
VALUES ('SYSTEM_PLUGIN_HA_SET_STATE',
        'Plugin',
        'hass_set_state',
        'HomeAssistant Device Status Modification',
        JSON_ARRAY(),
        60, 0, NOW(), 0, NOW());
...
-- ===============================
-- II. Delete old plugins.* parameters in sys_params
-- ===============================
DELETE
FROM sys_params
...
) COMMENT 'Unique Agent-Plugin Mapping Table';
