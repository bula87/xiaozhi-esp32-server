...
/**
 * Base service class, all Service should inherit
...
public abstract class BaseServiceImpl<M extends BaseMapper<T>, T> implements BaseService<T> {
    ...
    protected IPage<T> getPage(Map<String, Object> params, String defaultOrderField, boolean isAsc) {
        ...
        // Use default sort if no sort fields
    ...
    /**
     * <p>
     * Determine if the database operation is successful
     * </p>
     * <p>
     * Note！！ This method is for Integer judgment, do not pass int basic type
     * </p>
     *
     * @param result Database operation returns the number of affected rows
     * @return boolean
     */
