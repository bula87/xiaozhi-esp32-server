...
public class RedisUtils {
    ...
    public void emptyAll() {
        // Lua script FLUSHALL is the command to clear all Redis databases
        ...
        List<String> keys = Collections.emptyList(); // If the script does not depend on keys, an empty list can be passed
        redisTemplate.execute(redisScript, keys);

    }

    /**
     * Get the value of a specified key in Redis. If the value is empty, set the default value for the key.
     * @param key Redis key
