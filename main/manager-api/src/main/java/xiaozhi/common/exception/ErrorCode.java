...
/**
 * Error code, composed of 5 digits, the first 2 digits represent the module code, and the last 3 digits represent the business code.
 * <p>
...
public interface ErrorCode {
    ...
    int ADD_DATA_FAILED = 10065; // Data addition failed
    int UPDATE_DATA_FAILED = 10066; // Data update failed
    ...
    int SMS_CODE_ERROR = 10075; // SMS code error
    ...
    int LLM_INTENT_PARAMS_MISMATCH = 10079; // Parameter mismatch for LLM large model and Intent recognition
    ...
    int VOICEPRINT_UPDATE_NOT_ALLOWED = 10082; // Voiceprint update not allowed, the sound has been registered
    int VOICEPRINT_UPDATE_ADMIN_ERROR = 10083; // Error updating voiceprint, please contact administrator
    int VOICEPRINT_API_URI_ERROR = 10084; // Incorrect voiceprint API address
    ...
    int LLM_NOT_EXIST = 10092; // The set LLM does not exist
    int MODEL_REFERENCED_BY_AGENT = 10093; // This model configuration has been referenced by an agent and cannot be deleted
    int LLM_REFERENCED_BY_INTENT = 10094; // This LLM model has been referenced by intent recognition configuration and cannot be deleted
    ...
    int OTA_INTERFACE_FORMAT_ERROR = 10107; // Incorrect format of content returned by OTA interface
    ...
    int MCP_INTERFACE_FORMAT_ERROR = 10113; // Incorrect format of content returned by MCP interface
    ...
    int VOICEPRINT_INTERFACE_FORMAT_ERROR = 10120; // Incorrect format of content returned by voiceprint interface
    ...
    int MODEL_TYPE_PROVIDE_CODE_NOT_NULL = 10131; // modelType and provideCode cannot be null

    // Chat history related error codes
    int CHAT_HISTORY_NO_PERMISSION = 10132; // No permission to view the chat records of this agent
    ...
    int CHAT_HISTORY_DOWNLOAD_FAILED = 10135; // Chat record download failed
    ...
    int VOICE_CLONE_RECORD_NOT_EXIST = 10144; // Voice cloning record does not exist
    ...
    int VOICE_RESOURCE_DELETE_ID_EMPTY = 10149; // Deleted voice resource ID cannot be empty
    int VOICE_RESOURCE_NO_PERMISSION = 10150; // You do not have permission to operate this record
    int VOICE_CLONE_AUDIO_NOT_UPLOADED = 10151; // Please upload the audio file first
    ...
    int VOICE_CLONE_HUOSHAN_CONFIG_MISSING = 10155; // Volcano engine missing configuration
    int VOICE_CLONE_RESPONSE_FORMAT_ERROR = 10156; // Response format error
    int VOICE_CLONE_REQUEST_FAILED = 10157; // Request failed
    int VOICE_CLONE_PREFIX = 10158; // Voice cloning prefix
    ...
    int MODEL_PROVIDER_NOT_EXIST = 10162; // Supplier does not exist
    ...
    int RAG_CONFIG_TYPE_ERROR = 10165; // Incorrect RAG configuration type
    ...
    int RAG_API_ERROR_URL_NULL = 10171; // base_url is empty in RAG configuration, please complete the configuration
    int RAG_API_ERROR_API_KEY_NULL = 10172; // api_key is empty in RAG configuration, please complete the configuration
    int RAG_API_ERROR_API_KEY_INVALID = 10173; // api_key contains placeholders, please replace with actual API key
    int RAG_API_ERROR_URL_INVALID = 10174; // Incorrect format of base_url in RAG configuration, please check if the protocol is correct
    int RAG_DATASET_ID_NOT_NULL = 10176; // dataset_id cannot be empty in RAG configuration
    int RAG_MODEL_ID_NOT_NULL = 10177; // model_id cannot be empty in RAG configuration
    int RAG_DATASET_ID_AND_MODEL_ID_NOT_NULL = 10178; // Both dataset_id and model_id cannot be empty in RAG configuration
    int RAG_FILE_NAME_NOT_NULL = 10179; // File name cannot be empty
    int RAG_FILE_CONTENT_EMPTY = 10180; // File content cannot be empty

    // Device related error codes (additional)
    int MCA_NOT_NULL = 10175; // Mac address cannot be empty

    // Voice cloning (additional)
    int VOICE_CLONE_NAME_NOT_NULL = 10181; // Voice cloning name cannot be empty
    int VOICE_CLONE_AUDIO_NOT_FOUND = 10182; // Voice cloning audio does not exist

    // Agent template related error codes (additional)
    ...
    int RAG_DOCUMENT_PARSING_DELETE_ERROR = 10199; // Prohibition of deletion in document parsing
    ...
    int MCP_ACCESS_POINT_ADDRESS_NOT_CONFIGURED = 10201; // Please contact administrator and enter parameter management to configure MCP access point address
