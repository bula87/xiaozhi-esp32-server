...
public class AESUtils {
     ...
     * AES encryption
     * 
     * @param key       Key (16 bits, 24 bits, or 32 bits)
     * @param plainText Text to be encrypted
     * @return Encrypted Base64 string
     */
    public static String encrypt(String key, String plainText) {
        try {
            // Ensure the key length is 16, 24, or 32 bits
    ...
    /**
     * Pad the key to a specified length (16, 24, or 32 bits)
     * 
    ...
    private static byte[] padKey(byte[] keyBytes) {
        ...
        // If the key length is insufficient, pad with 0s; if exceeded, take the first 32 bits
