...
public class SysParamsController {
     ...
     * Validate WebSocket URL list
     *
     * @param urls WebSocket URL list, separated by semicolons
    ...
    private void validateOtaUrl(String paramCode, String url) {
        ...
        try {
            ...
            // Check if the response content contains OTA related information
    ...
    private void validateMcpUrl(String paramCode, String url) {
        ...
        try {
            ...
            // Check if the response content contains mcp related information
            String body = response.getBody();
    ...
    // Validate voice print interface address is normal
    ...
    // Check MQTT secret length and complexity
