...
public class ServerActionResponseDTO
{
    ...
    private String type;
    private Map<String, Object> content; // This field can be removed in the future and this class can be used as a base class with custom content types for business logic
