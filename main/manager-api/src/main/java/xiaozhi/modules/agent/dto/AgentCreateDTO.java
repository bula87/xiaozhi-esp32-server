...
/**
 * Agent creation DTO
 * Specifically used for adding agents, does not include id, agentCode, and sort fields, these fields are automatically generated/set to default values by the system
 */
@Data
