...
@Schema(description = "Agent management DTO")
public class AgentDTO {

    // ========== 1. Agent Management (CRUD) - Corresponds to RAGFlow_Agent interface details ==========
    @Data
    @Builder
    @NoArgsConstructor
    @AllArgsConstructor
    ...
    public static class ListReq implements Serializable {
        ...
        @Schema(description = "Order by field", defaultValue = "update_time")
        @JsonProperty("orderby")
        @Builder.Default
        private String orderby = "update_time";

        @Schema(description = "Descending order", defaultValue = "true")
        @JsonProperty("desc")
        @Builder.Default
    ...
    // ========== 2. Webhook debugging and tracing - Corresponds to RAGFlow_Agent interface details ==========
    @Data
    @Builder
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(description = "Webhook trigger request (parameters dynamic)")
    ...
    public static class WebhookTraceVO implements Serializable {
        ...
        @Schema(description = "Next query timestamp cursor")
    ...
    // ========== 3. Agent session - Corresponds to RAGFlow_Agent_Dify interface details ==========
    @Data
    @Builder
    @NoArgsConstructor
    @AllArgsConstructor
    ...
    public static class SessionListReq implements Serializable {
        ...
        @Schema(description = "Order by field", defaultValue = "create_time")
        @JsonProperty("orderby")
        @Builder.Default
        ...
        @Schema(description = "Return DSL", defaultValue = "false")
        @JsonProperty("dsl")
        @Builder.Default
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(description = "Session batch deletion request")
    ...
    // ========== 4. Agent conversation (Completion) - Corresponds to RAGFlow_Agent_Dify interface details ==========
    @Data
    @Builder
    @NoArgsConstructor
    @AllArgsConstructor
    ...
    public static class CompletionReq implements Serializable {
        ...
        @Schema(description = "Stream response", defaultValue = "true")
        @JsonProperty("stream")
        @Builder.Default
        private Boolean stream = true;

        @Schema(description = "Return trace information", defaultValue = "false")
    ...
    public static class CompletionVO implements Serializable {
        ...
        @Schema(description = "Reference source")
    ...
    // ========== 5. Dify compatible retrieval - Corresponds to RAGFlow_Agent_Dify interface details ==========
    @Data
    @Builder
    @NoArgsConstructor
    @AllArgsConstructor
    ...
    public static class DifyRetrievalReq implements Serializable {
        ...
        @Schema(description = "Use knowledge graph", defaultValue = "false")
        @JsonProperty("use_kg")
