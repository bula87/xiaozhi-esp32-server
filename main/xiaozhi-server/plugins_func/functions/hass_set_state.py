...
hass_set_state_function_desc = {
    ...
    "function": {
        "name": "hass_set_state",
        "description": "Set the state of a device in Home Assistant, including on/off, adjusting light brightness, color, color temperature, adjusting player volume, device pause, resume, and mute operations.",
        "parameters": {
            "type": "object",
            "properties": {
                "state": {
                    ...
                    "properties": {
                        ...
                        "is_muted": {
                            "type": "string",
                            "description": "Only needed when setting mute operation. Set to true for mute, false for unmute.",
                        },
                        "rgb_color": {
                            "type": "array",
                            "items": {"type": "integer"},
                            "description": "Only needed when setting color. Fill in the target color's RGB value here.",
                        },
                    },
                    "required": ["type"],
                },
                "entity_id": {
                    "type": "string",
                    "description": "The device id to operate, entity_id in Home Assistant.",
                },
            },
...
def hass_set_state(conn: "ConnectionHandler", entity_id="", state=None):
    ...
    try:
        ...
        logger.bind(tag=TAG).error("Timeout while setting Home Assistant state")
