...
hass_play_music_function_desc = {
    ...
    "function": {
        ...
        "description": "Used when the user wants to listen to music or audiobooks, plays the corresponding audio on the media player (media_player) in the room.",
        "parameters": {
            "type": "object",
            "properties": {
                "media_content_id": {
                    "type": "string",
                    "description": "Can be the album name, song name, or artist of music or audiobook. If not specified, use 'random'.",
                },
                "entity_id": {
                    "type": "string",
                    "description": "The device id of the speaker to operate, entity_id in Home Assistant, starts with media_player.",
                },
            },
