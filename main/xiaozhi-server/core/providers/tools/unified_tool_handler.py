...
class UnifiedToolHandler:
    ...
    async def _initialize(self):
        ...
        try:
            ...
            # Output list of currently supported tools
    ...
    async def _initialize_mcp_endpoint(self):
        ...
        try:
            ...
            self.logger.error(f"Initialization of MCP endpoint failed: {e}")
    ...
    def _initialize_home_assistant(self):
        ...
        try:
            ...
            self.logger.error(f"Initialization of Home Assistant failed: {e}")
    ...
    async def handle_llm_function_call(
        ...
        try:
            ...
            self.logger.debug(f"Function call: {function_name}, arguments: {arguments}")
    ...
    def _combine_responses(self, responses: List[ActionResponse]) -> ActionResponse:
        """Combine responses for multiple function calls"""
        if not responses:
