...
class AuthManager:
    ...
    Generates and verifies client_id, device_id, token (HMAC-SHA256) authentication triplet
    The token does not contain plaintext client_id/device_id, only carries signature + timestamp; client_id/device_id are passed during connection
