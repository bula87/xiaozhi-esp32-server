        ...
        try:
            ...
            if port:
                ...
                if not read_config_from_api:
                    # If the Smart Console is not enabled and only a single module is running, add a simple OTA interface for websocket delivery
                    app.add_routes(
                        [
                            ...
                            # Download interface, only provides data/bin/*.bin downloads
                            web.get(
